    ...
    while True:
        ...
        if current_room == 'Evil Room':
            ...
            if len(user_inventory) < 6:
                print()
                print("Oh no! Your soul has been sucked out of your body. Come back and try again.")
                print()
            elif len(user_inventory) == 6:
                print()
                print("*********************************************************************")
                print("Thermopalus couldn't stand up to your power and protection! You WIN!!!")
                print("*********************************************************************")
                print()
            break
